...
export function ImageUploader({ onImagesUploaded, isProcessing = false }: ImageUploaderProps) {
      ...
      {previewImages.length > 0 && (
        <div className="space-y-4">
          ...
          <div className="flex justify-center">
            <Button onClick={handleUpload} className="mt-4" disabled={isProcessing}>
              {isProcessing ? (
                <>
                ...
                <>
                  Process {previewImages.length} {previewImages.length === 1 ? "Image" : "Images"}
                </>
              )}
            </Button>
          </div>
